...
def sendEmail(name, email):
    ...
    attachment_path = '../data/Properties for sale Ireland.xlsx'
    with open(attachment_path, 'rb') as attachment:
        part = MIMEApplication(attachment.read(), Name='Properties for sale Ireland.xlsx')
        part['Content-Disposition'] = f'attachment; filename=Properties for sale Ireland.xlsx'
        msg.attach(part)
